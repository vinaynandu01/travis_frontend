...
function Register() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const endpoint = isAgent ? 'register-face' : 'register';
  ...
  return (
    <div className="background-shapes">
      <SecondaryNavbar />
      <div className={`container ${isAgent ? "active" : ""}`} id="container" style={{
        width: '100%',
        maxWidth: '850px',
        minHeight: '420px',
        background: 'white',
        ...
        {isAgent && (
          <div style={{
            ...
            <p style={{
              ...
              Use facial recognition to create your account and access our platform designed for visually impaired agents.
            </p>
          </div>
        )}
        ...
        {!isAgent && (
          <div style={{
            ...
            <p style={{
              ...
              Create your administrator account to manage and oversee the platform operations effectively.
            </p>
          </div>
        )}
      </div>
